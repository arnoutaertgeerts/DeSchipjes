...
model Renovated "A complete building model for testing"
  ...
  IDEAS.Interfaces.Building building(
    ...
    redeclare DeSchipjes.Dwellings.HeatingSystems.HTHeatingSystem heatingSystem(
      ...
      heatExchanger(measureReturnT=true, massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
      pumpRadiators(measureSupplyT=false, measureReturnT=false,
        flowRegulator(filteredSpeed=false),
      ...
      rad(energyDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial,
          massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
      parallelPipesSplitter(vol(massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)),

      pumpDHW(massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
      heatExchanger1(massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)),
