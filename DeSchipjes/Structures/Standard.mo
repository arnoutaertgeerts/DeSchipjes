...
model Standard "Standaard woning de schipjes"
  ...
  IDEAS.Buildings.Components.BoundaryWall woonruimteGemeenschappelijk(
    AWall=17.10,
    redeclare DeSchipjes.Data.Constructions.GemeneMuur constructionType,
  ...
  IDEAS.Buildings.Components.InternalWall woonruimteKeuken(
    AWall=6.97,
    redeclare DeSchipjes.Data.Constructions.BinnenMuur constructionType,
    insulationThickness=0,
    inc=1.5707963267949,
  ...
  IDEAS.Buildings.Components.OuterWall woonruimteKoer(
    AWall=5.15,
    redeclare DeSchipjes.Data.Constructions.BuitenMuurDik constructionType,
  ...
  IDEAS.Buildings.Components.SlabOnGround woonruimteVloer(
    ...
    azi=0,
    AWall=woonruimteA,
    redeclare DeSchipjes.Data.Constructions.Vloer constructionType,
    insulationThickness=isolatieTest)
  ...
  IDEAS.Buildings.Components.InternalWall woonruimteHal(
    ...
    inc=0,
    azi=0,
    redeclare DeSchipjes.Data.Constructions.Plafond constructionType,
    insulationThickness=0)
  ...
  IDEAS.Buildings.Components.Window wooruimteWindow(
    A=5.78,
    frac=0.12,
    redeclare DeSchipjes.Data.Glass.VoorzetRaam glazing,
    redeclare DeSchipjes.Data.Frames.LoofHout fraType,
  ...
  IDEAS.Buildings.Components.Window keukenWindowLarge(
    ...
    inc=1.5707963267949,
    azi=3.9444441095072,
    redeclare DeSchipjes.Data.Glass.DubbelGlas glazing)
  ...
  IDEAS.Buildings.Components.OuterWall keukenDak(
    ...
    redeclare DeSchipjes.Data.Constructions.DakBijBouw constructionType,
    redeclare DeSchipjes.Data.Insulation.RotsWolSKepers insulationType)
  ...
  IDEAS.Buildings.Components.OuterWall WCKoer(
    AWall=2.83,
    insulationThickness=0,
    redeclare DeSchipjes.Data.Constructions.BuitenMuurDun constructionType,
    inc=1.5707963267949,
    azi=2.3736477827123)
  ...
  IDEAS.Buildings.Components.Window raamwc(
    ...
    inc=1.5707963267949,
    azi=3.9444441095072,
    redeclare DeSchipjes.Data.Glass.EnkelGlass glazing,
    redeclare DeSchipjes.Data.Frames.LoofHout fraType)
  ...
  IDEAS.Buildings.Components.OuterWall slaakamerDakLinks(
    AWall=11.73,
    insulationThickness=0.08,
    redeclare DeSchipjes.Data.Constructions.DakHoofdGebouw constructionType,
    redeclare DeSchipjes.Data.Insulation.RotsWolSpanten insulationType,
    inc=5.235987755983,
    azi=2.3736477827123) annotation (Placement(transformation(
        extent={{-5,-10},{5,10}},
        rotation=270,
