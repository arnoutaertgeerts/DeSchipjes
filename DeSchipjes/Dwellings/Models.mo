...
package Models
  ...
  equation
    ...
    connect(dHConnection1.port_b3, building1.flowPort_supply) annotation (Line(
        ...
        color={0,127,255},
        smooth=Smooth.None));
    connect(idealModulatingProduction.port_b, dHConnection.port_a1)
      annotation (Line(points={{-40,-16},{8,-16}}, color={0,127,255}));
    connect(idealModulatingProduction.port_a, dHConnection.port_b2)
      annotation (Line(points={{-40,-28},{-16,-28},{8,-28}}, color={0,127,255}));
