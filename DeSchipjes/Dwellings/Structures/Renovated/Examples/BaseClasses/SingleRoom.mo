...
model SingleRoom
  ...
  inner IDEAS.SimInfoManager sim(offsetAzi=2.3736477827123)
...
//         origin={-100,-17})));
  ...
  IDEAS.Buildings.Components.BoundaryWall halGemeenschappelijk1(
     AWall=4.05,
    final insulationThickness=0,
    redeclare final Data.Constructions.Old.GemeneMuur
      constructionType,
    inc=1.5707963267949,
    azi=2.3736477827123)
    annotation (Placement(transformation(extent={{-64,-18},{-54,2}})));
equation
  ...
  connect(boundary.ports[1], nachthal.flowPort_In) annotation (Line(
      ...
      color={0,127,255},
      smooth=Smooth.None));
//   connect(keukenWindowLarge.propsBus_a, nachthal.propsBus[]) annotation (Line(
//       points={{-56,-2},{-30,-2},{-30,31},{-4,31}},
//       color={255,204,51},
//       thickness=0.5,
//       smooth=Smooth.None));
...
//       smooth=Smooth.None));
  connect(realExpression.y, TSensor) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(halGemeenschappelijk1.propsBus_a, nachthal.propsBus[3]) annotation (
      Line(
      points={{-54,-4},{-22,-4},{-22,31.3333},{-4,31.3333}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
