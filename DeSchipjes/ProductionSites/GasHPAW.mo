...
equation
  ...
  connect(bou.ports[1], fan.port_a) annotation (Line(points={{10,-56},{10,-60},{
          -12,-60}},  color={0,127,255}));
  connect(fan.port_b, TBasei.port_a) annotation (Line(points={{-32,-60},{-66,-60},
  ...
  connect(TBaseo.port_b, tan.portHex_a) annotation (Line(points={{-6,20},{4,20},
          {4,20.2}},       color={0,127,255}));
  connect(boiler.port_b, TPeako.port_a)
    annotation (Line(points={{74,60},{74,60},{78,60}},
                                               color={0,127,255}));
  ...
  connect(TRoo.port, tan.heaPorSid) annotation (Line(points={{80,0},{64,0},{64,28},
          {19.6,28},{19.6,24}},
                              color={191,0,0}));
  connect(Controls.hpOn, hpaw.on) annotation (Line(points={{-43.4,62},{-38,62},{
          -38,30.8}}, color={255,0,255}));
  ...
  connect(booleanToReal.u, hpaw.on) annotation (Line(points={{-22,-22.8},{-22,62},
  ...
  connect(Controls.hp, hpaw.u) annotation (Line(points={{-43.4,58},{-34,58},{-34,
          30.8}}, color={0,0,127}));
  connect(threeWayValveSwitch.port_a2, TPeaki.port_a)
  ...
  connect(tan.port_a, TPeaki.port_a) annotation (Line(points={{4,24},{0,24},{0,46},
          {38,46},{38,60}}, color={0,127,255}));
